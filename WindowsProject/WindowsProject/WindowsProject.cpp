...
static TCHAR szTitle[] = _T("Example");
...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    {
        MessageBox(NULL, _T("Call to RegisterClassEx failed!"), _T("Example"), NULL);
        return 1;
    }
    ...
    if (!hWnd)
    {
        MessageBox(NULL, _T("Call to CreateWindow failed!"), _T("Example"), NULL);
        return 1;
    }
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    PAINTSTRUCT ps;
    HDC hdc;
    TCHAR greeting[] = _T("Hello, world! (｡◕‿◕｡)");
